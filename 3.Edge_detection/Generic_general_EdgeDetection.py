...
plt.show()
#Difference of gaussian kernels can also be applied for even increasing accuracy.
...
plt.savefig('res_horizontal_edge_detection')
plt.show()
...
plt.savefig('res_vertical_edge_detection')
plt.show()
